...
/*
 * This program converts ack.out format to i8086 V6 a.out format.
...
#ifndef NORCSID
static char rcs_id[] = "$Id: cv.c,v 1.3 1994/06/24 13:12:05 ceriel Exp $" ;
#endif
